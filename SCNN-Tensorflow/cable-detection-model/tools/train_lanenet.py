...
def train_net(dataset_dir, weights_path=None, net_flag='vgg'):
    ...
    train_dataset = lanenet_data_processor.DataSet(train_dataset_file) #return:img, label_instance, label_existence
    ...
    img, label_instance, label_existence = train_dataset.next_batch(CFG.TRAIN.BATCH_SIZE)#批量处理
            ...
            with tf.device('/gpu:%d' % i):
                with tf.name_scope('tower_%d' % i) as scope:
                    total_loss, instance_loss, existence_loss, accuracy, accuracy_back, _, out_logits_out, \
                        grad = forward(batch_queue, net, phase, scope, optimizer)# calculate gradient
    ...
    model_save_dir = '/Users/wutong/Downloads/train_set/model'
...
if __name__ == '__main__':
    ...
    #train_net("/Users/wutong/Downloads/train_set/tusimple-list_2", "/Users/wutong/Desktop/model_culane-71-3/culane_lanenet_vgg_2018-12-01-14-38-37.ckpt-10000", net_flag="vgg")
    # args.dataset_dir
    # weights_path = "/Users/wutong/Desktop/model_culane-71-3/culane_lanenet_vgg_2018-12-01-14-38-37.ckpt-10000"
    # net_flag == 'vgg'
