...
class DataSet(object):
    ...
    def __init__(self, dataset_info_file):
        ...
        self._img, self._label_instance, self._label_existence = self._init_dataset() #更新
    ...
    def _init_dataset(self):
        ...
        with open(self.dataset_info_file, 'r') as file:
            for _info in file:
                ...
                img_list.append("/Users/wutong/Downloads/train_set/"+info_tmp[0][1:]) #image 地址
                label_instance_list.append("/Users/wutong/Downloads/train_set/"+info_tmp[1][1:]) #GT地址
        ...
        with tf.name_scope('data_augmentation'):
            ...
            img = self.process_img(input_queue[0])#处理原图
            label_instance = self.process_label_instance(input_queue[1]) #处理GT图
            label_existence = self.process_label_existence(input_queue[2]) #处理 0-1 label
